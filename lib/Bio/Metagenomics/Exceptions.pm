...
use Exception::Class (
    ...
    Bio::Metagenomics::Exceptions::FileNotFound => { description => 'File not found' },
    ...
    Bio::Metagenomics::Exceptions::GenbankPathExtraction => { description => 'Unable to extract assembly paths from GenBank summary' },
    Bio::Metagenomics::Exceptions::GenBankIdNotFound => { description => 'Unable to find assembly ID in summary file' },
